    <script type="text/babel">
        ...
        // FIX: Accessing Framer Motion components via the globally exposed name, using a known working fallback
        // The unpkg load above usually exposes the library as 'window.FramerMotion' or just 'FramerMotion'.
        // We use || {} to prevent the crash if it's still undefined.
...
Today, Daniel leads short, focused projects that align teams, define simple success metrics, and install the right tools to test ideas weekly and double down on what works. Fluent in English and Spanish, Daniel works across the U.S. and Latin America.`;
        ...
        const App = () => {
          ...
          return (
            ...
            <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans mx-auto max-w-full md:max-w-5xl">
              {/* NAV */}
